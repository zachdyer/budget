...
budget.all = [
	...
	new Budget('Merchant Fees',65,2, false, true)
];
...
balance.current = 0;//Number(prompt("How much do you have in your bank account?"));
balance.minimum = 0;
...
update.billHeader = function(){
	...
	var totalLeft =  budget.month + " Bills $" + budget.current.toFixed(2);
